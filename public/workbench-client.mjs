 ...
 */
export function createAnnotatedTextHttpSession({ baseUrl, context, historySession, fetchImpl, eventSourceFactory, createActionId, onRecoveryDelayed, onFoldApplied, typingBurstIdleMs = 75, typingBurstMaxMs = 150 }) {
  ...
  function currentAnnotatedDocument() {
    ...
    return Object.freeze({
      ...
      blocks: Object.freeze((view.blocks ?? []).map((block) => block.id === 'b'
        ? Object.freeze({ ...block, text: queuedDocumentText })
        : block)),
    });
  }
