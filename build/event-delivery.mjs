...
// (consideration #23).
export function isAuthoritativeEnvelope(envelope         )                                          {
...
export function envelopeDiagnostics(envelope         )                                                                                          {
  ...
  if (Number.isSafeInteger(record.seq)) diagnostics.seq = record.seq          ;
