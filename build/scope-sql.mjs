...
const sqlNull = (value         )          => value === null || value === undefined;
...
function evaluateScopeNode(node         , ctx                  )             {
  switch (node.node) {
    ...
    case 'not': {
      const inner = evaluateScopeNode(node.operand           , ctx);
    ...
    case 'and': {
      ...
      for (const operand of node.operands             ) {
        const inner = evaluateScopeNode(operand           , ctx);
