 ...
 */
function normalizeEditOverlap(owner        , editOverlap     )      {
...
export function annotation(name        , { appliesTo = 'text-range', cardinality = 'many', fields = {}       , actions = {}, empty = 'delete', editOverlap = null }      = {})      {
