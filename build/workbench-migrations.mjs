...
function repairIntermediateMembershipFamily(db          , prefix        ) {
  ...
  const columns = new Set(db.prepare(`PRAGMA table_info(${membership})`).all().map((row) => row.name          ));
