...
export function isErasureDirective(value         )                            {
  return (value                                         )?.kind === 'workbench.erasure'
    && (value                                            )?.version === 1;
}
...
export function isErasureDirectivePreparation(value         )                              {
  return (value                                         )?.kind === 'workbench.erasure.preparation'
    && (value                                            )?.version === 1;
}
...
function censusTargets(db          , { owningScope, subject, census }                    , excludeActionId               )                                                                     {
