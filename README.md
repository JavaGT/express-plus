...
*Express, but for collaborative, persisted, realtime data.*
...
scope is the working proof; express-plus is the cleaner second cut, built
...
| Document | Job |
| --- | --- |
| **[SPEC.md](SPEC.md)** | The canonical specification — what express-plus is, how it behaves, the build order. The single source of truth. |
...
| **[SCOPE-FINDINGS.md](SCOPE-FINDINGS.md)** | What the shipped `scope` workbench proves is buildable; the validated architecture shape express-plus adopts. |
