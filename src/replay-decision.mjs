...
export function normalizeSeqSpan(seqOrSpan) {
 ...
 *
 * @param {number} cursor - last applied sequence (0 before any event)
 * @param {number|[number,number]} seqOrSpan - event seq or [lo, hi] span
 * @returns {{ kind: 'duplicate' } | { kind: 'gap' } | { kind: 'next', cursor: number }}
 */
export function decideReplay(cursor, seqOrSpan) {
