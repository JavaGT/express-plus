...
| W4 UI kit | `W4-ui-kit.md` | building (waves 1-3 of 4) | `convergence/W4-wave1` (1), `convergence/W4-wave2` (2), `convergence/W4-wave3` (3) | 1556/1556 + 142/142 browser | Wave 1: 3 primitives (ActionButton, TextInput, ListView). Wave 2: 5 primitives (FormInput, Modal, ConnectionIndicator, Dropdown, OptimisticBadge). Wave 3: 8 primitives (Toast, SearchInput, DatePicker, EmptyState, Spinner, Tabs, Progress, Tag). 16 of 25 shipped. |
