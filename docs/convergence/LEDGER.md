...
| W4 UI kit | `W4-ui-kit.md` | building (waves 1-2 of 4) | `convergence/W4-wave1` (1), `convergence/W4-wave2` (2) | 1498/1498 + 84/84 browser | Wave 1: ActionButton, TextInput, ListView. Wave 2: FormInput, Modal, ConnectionIndicator, Dropdown, OptimisticBadge. Council-reviewed (c03): bindConnection no longer polls private internals; OptimisticBadge uses boundAction handle. W5 filings: onConnectionChange, overlay-status API. |
