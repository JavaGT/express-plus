...
| W4 UI kit | `W4-ui-kit.md` | building (wave 1 of 4) | `convergence/W4-wave1` | 1458/1458/0 + 44/44 browser | Wave 1: ActionButton, TextInput, ListView — Svelte 5 components + framework-agnostic bindAction/bindField/bindList helpers. 46 new tests. Owner overruled council c02 (Option C, Svelte-first per Scope's stack). |
