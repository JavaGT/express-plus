...
- Snapshot matching still compares the opaque scope identity to the target ID.
  The application must create that identity before its first tombstone and
  retain it while tombstones refer to it.
