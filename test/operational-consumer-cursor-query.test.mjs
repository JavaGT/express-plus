...
import { createOperationalConsumers, defineOperationalEvent, operationalConsumer } from '../build/operational-consumer.mjs';
...
test('operational reconciliation reads only records beyond its durable per-scope cursor', async () => {
  ...
  db.exec(`
    ...
    CREATE TABLE _ConsumerCursor (
      consumer TEXT NOT NULL,
      scope TEXT NOT NULL,
      lastSeq INTEGER NOT NULL,
      PRIMARY KEY (consumer, scope)
    );
    CREATE TABLE _OperationalConsumerDeclaration (
      name TEXT PRIMARY KEY,
      declarationFingerprint TEXT NOT NULL
    );
    CREATE TABLE _OperationalConsumerFailure (
      consumer TEXT NOT NULL,
      scope TEXT NOT NULL,
